  ...
  return (
    <div className="flex gap-20 py-16 px-10 max-lg:flex-col">
        ...
        {cart.cartItems.length === 0 ? (
          ...
          <div className="">
            {cart.cartItems.map((cartItem) => (
              <div className="w-full flex max-sm:flex-col max-sm:gap-3 max-sm:items-start hover:bg-grey-1 px-6 py-5 justify-between items-center">
      ...
      <div className="w-1/3 max-lg:w-full flex flex-col gap-8 bg-grey-1 rounded-lg px-4 py-5 ">
        ...
        <div className="flex justify-between text-body-semilod">
