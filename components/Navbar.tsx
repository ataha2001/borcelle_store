...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 z-10 py-2 px-10 flex gap-2 justify-between items-center bg-white max-sm:px-2 shadow-md'>
        <Link href={'/'}>
            <Image src='/logo.png' width={130} height={100} alt='lgo' />
        </Link>
